...
class Cita_model extends MY_Model {
	...
	public function get_citas($order_by = 'hora_cita', $order = 'asc', $limit = 0, $offset = 0, $fechaActual = '', $horaSolicitada = '', $odontologoActual = '') {
	...
	public function get_citas_cliente($order_by = 'hora_cita', $order = 'asc', $limit = 0, $offset = 0, $idCliente = '') {
        /*
