         	...
         	<div class="box-body">
                    <div class="form-group text-center">
						...
						if($administrador_info->foto_persona){
							echo '<img id="foto_img" class="center-block" height="240" src="'.base_url() . "uploads/admin/" . $administrador_info->foto_persona . '">';
            	...
            	<div class="row">
					...
					<div class="col-lg-6 form-group">
                        ...
                        <div class="input-group" id="div_inputDocumento">
                            ...
                            <input type="number" class="form-control" id="inputDocumento" placeholder="Número de documento" name="inputDocumento" value="<?php echo $administrador_info->documento_persona;?>">
                      	</div>
                 	</div>                                                                                                  
               	</div>  
