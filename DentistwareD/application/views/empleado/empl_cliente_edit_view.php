            	...
            	<div class="row">
					...
					<div class="col-lg-6 form-group">
                        ...
                        <div class="input-group" id="div_inputDocumento">
                            ...
                            <input type="number" class="form-control" id="inputDocumento" placeholder="Número de documento" name="inputDocumento" value="<?php echo $cliente_info->documento_persona;?>">
                      	</div>
                 	</div>                                                                                                  
               	</div>  
